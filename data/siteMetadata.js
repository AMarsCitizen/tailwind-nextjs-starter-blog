...
const siteMetadata = {
  ...
  siteUrl: process.env.NEXT_PUBLIC_SITE_URL || 'https://wahbi-hamza.vercel.app',
  siteRepo:
    process.env.NEXT_PUBLIC_SITE_REPO || 'https://github.com/AMarsCitizen/tailwind-nextjs-starter-blog',
